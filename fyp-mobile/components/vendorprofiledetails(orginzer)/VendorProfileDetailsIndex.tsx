      ...
      >
        ...
        <View style={styles.coverWrapper}>
          ...
          <View style={styles.header}>
            ...
            <TouchableOpacity
              onPress={() => router.push('/cartmanagement' as never)}
...
const styles = StyleSheet.create({
  ...
  coverOverlay: { position: 'absolute', top: 0, left: 0, right: 0, height: 90, backgroundColor: 'rgba(0,0,0,0.28)' },
  header: { position: 'absolute', top: 44, left: 0, right: 0, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 14 },
  backIconButton: { width: 38, height: 38, borderRadius: 19, backgroundColor: 'rgba(0,0,0,0.35)', alignItems: 'center', justifyContent: 'center' },
  cartIconButton: { width: 38, height: 38, borderRadius: 19, backgroundColor: 'rgba(0,0,0,0.35)', alignItems: 'center', justifyContent: 'center' },
  title: { flex: 1, fontSize: 17, fontWeight: '700', textAlign: 'center', color: '#FFFFFF', marginHorizontal: 8 },
  tabContainer: { flexDirection: 'row', backgroundColor: CARD, marginHorizontal: 16, marginTop: -22, borderRadius: 16, padding: 4, shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 4, zIndex: 5 },
  ...
  card: { backgroundColor: CARD, borderRadius: 16, padding: 16, marginBottom: 14, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 8, shadowOffset: { width: 0, height: 3 }, elevation: 2, borderWidth: 1, borderColor: BORDER },
  rowContainer: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
  priceBadge: { backgroundColor: PRIMARY_SOFT, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 10, alignItems: 'flex-end' },
  ...
  sectionIconCircle: { width: 28, height: 28, borderRadius: 14, backgroundColor: '#F3D9EC', alignItems: 'center', justifyContent: 'center', marginRight: 8 },
  ...
  photoWrapper: { marginRight: 10, borderRadius: 16, overflow: 'hidden', shadowColor: PRIMARY, shadowOpacity: 0.12, shadowRadius: 6, shadowOffset: { width: 0, height: 3 }, elevation: 3 },
  photo: { width: 104, height: 104, borderRadius: 12, backgroundColor: '#EEE' },
  noPhotosBox: { alignItems: 'center', justifyContent: 'center', paddingVertical: 28, backgroundColor: '#FBF6FA', borderRadius: 16, borderWidth: 1, borderColor: '#F1D5E8', borderStyle: 'dashed' },
  ...
  packageCard: { width: 128, backgroundColor: CARD, borderRadius: 16, padding: 12, marginRight: 10, borderWidth: 1.5, borderColor: BORDER, position: 'relative' },
  activePackageCard: { backgroundColor: PRIMARY, borderColor: PRIMARY, shadowColor: PRIMARY, shadowOpacity: 0.3, shadowRadius: 8, shadowOffset: { width: 0, height: 4 }, elevation: 4 },
  packageCardIconWrap: { width: 32, height: 32, borderRadius: 10, backgroundColor: PRIMARY_SOFT, alignItems: 'center', justifyContent: 'center', marginBottom: 10 },
  ...
  activeDot: { position: 'absolute', top: 10, right: 10, width: 16, height: 16, borderRadius: 8, backgroundColor: 'rgba(255,255,255,0.25)', alignItems: 'center', justifyContent: 'center' },
  customPackageCard: { width: 128, borderRadius: 16, padding: 12, marginRight: 10, borderWidth: 1.5, borderStyle: 'dashed', borderColor: PRIMARY_LIGHT, backgroundColor: PRIMARY_SOFT, alignItems: 'flex-start', justifyContent: 'center' },
  customPackageCardActive: { borderStyle: 'solid', backgroundColor: PRIMARY },
  customPackageIconWrap: { width: 32, height: 32, borderRadius: 10, backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center', marginBottom: 10 },
  ...
  packageBadgeIcon: { width: 40, height: 40, borderRadius: 12, backgroundColor: PRIMARY, alignItems: 'center', justifyContent: 'center' },
  ...
  packagePriceFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: PRIMARY_SOFT, paddingHorizontal: 16, paddingVertical: 14 },
  ...
  customPackagePanelIcon: { width: 52, height: 52, borderRadius: 26, backgroundColor: PRIMARY_SOFT, alignItems: 'center', justifyContent: 'center', marginBottom: 12 },
  customPackagePanelTitle: { fontSize: 15, fontWeight: '800', color: TEXT_DARK, marginBottom: 6 },
  customPackagePanelText: { fontSize: 13, color: TEXT_MUTED, textAlign: 'center', lineHeight: 19, paddingHorizontal: 20 },
  cartButton: { marginTop: 0, flexDirection: 'row', alignItems: 'center', gap: 6, paddingVertical: 8, paddingHorizontal: 18, backgroundColor: PRIMARY, borderRadius: 20 },
  ...
  filterChip: { paddingVertical: 8, paddingHorizontal: 14, borderRadius: 20, borderWidth: 1, borderColor: '#E0E0E0', backgroundColor: '#FFFFFF', marginRight: 8 },
  ...
  loadMoreButton: { minHeight: 42, paddingHorizontal: 20, borderRadius: 22, borderWidth: 1, borderColor: PRIMARY, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', alignSelf: 'center', marginVertical: 16 },
  ...
  pickMediaButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: PRIMARY, borderStyle: 'dashed', borderRadius: 8, paddingVertical: 12, marginBottom: 10 },
